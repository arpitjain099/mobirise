...
<section class="mbr-box mbr-section mbr-section--relative mbr-section--fixed-size mbr-section--full-height mbr-section--bg-adapted mbr-parallax-background mbr-after-navbar" id="header1-73" style="background-image: url(assets/images/macbook-926425-1920-1920x1279-92.jpg);">
  ...
  <link rel="stylesheet" href="assets/bootstrap/css/bootstrap.vertical-tabs.css">
                ...
                <div class="row">
                    ...
                    <div class="mbr-buttons btn-inverse mbr-buttons--left"><a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-warning" href="features1-75">Interested</a> <a class="mbr-buttons__btn btn btn-lg btn-default animated fadeInUp delay" href="https://mobirise.com/bootstrap-template/">Bookmark for later</a></div>
                </div></div>
            </div></div>
        </div>
            ...
            <div>
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <div>
                            <h4>Tags</h4>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae.  </p>
                            <h4>Location</h4>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae.  </p>
                        </div>
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                         <div class="mbr-buttons btn-inverse mbr-buttons--left">
                            <a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-warning" href="features1-75">Interested</a><br> 
                            <a class="mbr-buttons__btn btn btn-lg animated fadeInUp delay btn-warning" href="features1-75">Bookmark for later</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mbr-box__magnet mbr-box__magnet--sm-padding mbr-box__magnet--center-left">
                ...
                <div class=" col-sm-4">
                          ...
                          <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="http://cdn.osxdaily.com/wp-content/uploads/2010/10/giant-apple-logo-bw.png" class=" col-sm-3"/><p>Rockstar 1 <br>Name
                                            <br> Credentials</p></td>
                                    </tr>
                                     <tr>
                                        <td><img src="http://cdn.osxdaily.com/wp-content/uploads/2010/10/giant-apple-logo-bw.png" class=" col-sm-3"/>Rockstar 1 <br>Name
                                            <br> Credentials</td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="pitchvideo">  <iframe src="https://www.youtube.com/embed/su0C_EdEWNU?rel=0" frameborder="0" allowfullscreen></iframe></div>
            
            <div class="tab-pane" id="presentation"><iframe src="//www.slideshare.net/slideshow/embed_code/key/HlffpWO9MWg5NQ" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe> <div style="margin-bottom:5px"> </div></div>
            <div class="tab-pane" id="market">Market</div>
            <div class="tab-pane" id="competition">Competition</div>
            <div class="tab-pane" id="qna"><div id="disqus_thread"></div>
<script>
    /**
    ...
    */
    (function() {  // DON'T EDIT BELOW THIS LINE
        ...
        s.src = '//arpitjainswebsite.disqus.com/embed.js';
...
No new announcements as of now!
